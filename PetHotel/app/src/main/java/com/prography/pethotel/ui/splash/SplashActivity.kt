...
//        val loggedInStateViewModel = ViewModelProvider(
//            this, LoggedInStateFactory()
//        )[LoggedInStateViewModel::class.java]

//        if(loggedInStateViewModel.getUserToken(this).token.isNotEmpty()){
//            Handler().postDelayed({
